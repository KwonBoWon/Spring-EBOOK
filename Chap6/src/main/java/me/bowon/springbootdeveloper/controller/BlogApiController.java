...
import me.bowon.springbootdeveloper.dto.ArticleResponse;
...
public class BlogApiController {
    ...
    // HTTP 메서드가 POST일 때 전달받은 URL에 동일하면 메서드로 매핑
    ...
    // URL 경로에서 값 추출
    public ResponseEntity<ArticleResponse> findArticle(@PathVariable long id){ // URL에서 {id}가져옴
    ...
    public ResponseEntity<Void> deleteArticle(@PathVariable long id){ // URL에서 {id}가져옴
